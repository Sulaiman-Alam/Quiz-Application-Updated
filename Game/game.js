...
// Being trying but the questions arent being fetched

// const fetchQuestions = async () => {
//   try {
//     const response = await fetch('questions.json'); // Change this to the path of your JSON file
//     if (!response.ok) throw new Error('Failed to fetch questions');

//     const data = await response.json();
//     questions = data.questions; // Assuming the JSON structure is like { questions: [...] }
//     startGame(); // Start the game once the questions are loaded
//   } catch (error) {
//     console.error(error);
...
document.querySelectorAll('.choice-container').forEach(choiceContainer => {
  choiceContainer.addEventListener('click', (e) => {
      ...
      // Identify the answer by looking for the dataset "letter"
      const selectedAnswer = choiceContainer.querySelector('.choice-text').dataset["letter"];
      ...
      if (classToApply === "correct") {
          increaseScore(QUESTION_CORRECT_BONUS);
      }
